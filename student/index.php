    ...
    <form action="" method="post">
        <div class="panel-body">
          <div class="form-group">
              ...
              <input class="form-control <?php if(!empty($roll_no_error)) echo 'is-invalid'; ?>" value="<?php echo $roll_no; ?>" name="roll_no" id="roll-no" type="text" placeholder="Roll Number">
              <div class="invalid-feedback">
                  <?php echo $roll_no_error; ?>
              </div>
          </div>
          <div class="form-group">
